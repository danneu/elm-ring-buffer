...
var _user$project$Internal$Internal = F4(
	function (a, b, c, d) {
		return {array: a, start: b, end: c, length: d};
	});

var _user$project$Util$unwrapMaybe = function (maybe) {
	var _p0 = maybe;
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
...
var _user$project$Util$applyRepeatedly = F3(
	function (times, fn, initValue) {
		return A3(
			_elm_lang$core$List$foldl,
			F2(
				function (_p2, value) {
			...
			initValue,
			A2(_elm_lang$core$List$range, 0, times - 1));
	});

var _user$project$RingBuffer$last = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1._0;
	return _elm_lang$core$Native_Utils.eq(_p2.length, 0) ? _elm_lang$core$Maybe$Nothing : _user$project$Util$unwrapMaybe(
		A2(_Skinney$elm_array_exploration$Array_Hamt$get, _p2.end, _p2.array));
};
var _user$project$RingBuffer$first = function (_p3) {
	var _p4 = _p3;
	var _p5 = _p4._0;
	return _elm_lang$core$Native_Utils.eq(_p5.length, 0) ? _elm_lang$core$Maybe$Nothing : _user$project$Util$unwrapMaybe(
		A2(_Skinney$elm_array_exploration$Array_Hamt$get, _p5.start, _p5.array));
};
var _user$project$RingBuffer$length = function (_p6) {
	var _p7 = _p6;
	return _p7._0.length;
};
var _user$project$RingBuffer$capacity = function (_p8) {
	var _p9 = _p8;
	return _Skinney$elm_array_exploration$Array_Hamt$length(_p9._0.array);
};
var _user$project$RingBuffer$toArray = function (_p10) {
	var _p11 = _p10;
	var _p12 = _p11._0;
	var end = _p12.length;
	var start = 0;
	var size = (_elm_lang$core$Native_Utils.cmp(start, end) < 0) ? (end - start) : 0;
	var accumulate = F2(
		function (i, accum) {
			var internalIndex = A2(
				_elm_lang$core$Basics_ops['%'],
				(_p12.start + start) + i,
				_user$project$RingBuffer$capacity(_p11));
			var value = _user$project$Util$unwrapMaybe(
				_user$project$Util$unwrapMaybe(
					A2(_Skinney$elm_array_exploration$Array_Hamt$get, internalIndex, _p12.array)));
			return A2(_Skinney$elm_array_exploration$Array_Hamt$push, value, accum);
		});
	return A3(
		_elm_lang$core$List$foldl,
		accumulate,
		_Skinney$elm_array_exploration$Array_Hamt$empty,
		A2(_elm_lang$core$List$range, 0, size - 1));
};
var _user$project$RingBuffer$toList = function (_p13) {
	return _Skinney$elm_array_exploration$Array_Hamt$toList(
		_user$project$RingBuffer$toArray(_p13));
};
var _user$project$RingBuffer$get = F2(
	function (externalIdx, _p14) {
		var _p15 = _p14;
		var _p16 = _p15._0;
		var internalIdx = A2(
			_elm_lang$core$Basics_ops['%'],
			_p16.start + externalIdx,
			_user$project$RingBuffer$capacity(_p15));
		return A2(
			_elm_lang$core$Maybe$map,
			_user$project$Util$unwrapMaybe,
			A2(_Skinney$elm_array_exploration$Array_Hamt$get, internalIdx, _p16.array));
	});
var _user$project$RingBuffer$isEmpty = function (_p17) {
	var _p18 = _p17;
	return _elm_lang$core$Native_Utils.eq(_p18._0.length, 0);
};
var _user$project$RingBuffer$RingBuffer = function (a) {
	return {ctor: 'RingBuffer', _0: a};
};
var _user$project$RingBuffer$empty = function (maxSize) {
	return _user$project$RingBuffer$RingBuffer(
		{
			array: A2(
				_Skinney$elm_array_exploration$Array_Hamt$initialize,
				maxSize,
...
var _user$project$RingBuffer$pop = function (_p19) {
	var _p20 = _p19;
	var _p22 = _p20;
	var _p21 = _p20._0;
	if (_user$project$RingBuffer$isEmpty(_p22)) {
		return {ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: _p22};
	} else {
		var length_ = _p21.length - 1;
		var array_ = A3(_Skinney$elm_array_exploration$Array_Hamt$set, _p21.end, _elm_lang$core$Maybe$Nothing, _p21.array);
		var value = _user$project$Util$unwrapMaybe(
			A2(_Skinney$elm_array_exploration$Array_Hamt$get, _p21.end, _p21.array));
		var maxSize = _user$project$RingBuffer$capacity(_p22);
		var end_ = A2(_elm_lang$core$Basics_ops['%'], (_p21.end - 1) + maxSize, maxSize);
		var buf_ = _elm_lang$core$Native_Utils.update(
			_p21,
			{array: array_, end: end_, length: length_});
		return {
			ctor: '_Tuple2',
			_0: value,
			_1: _user$project$RingBuffer$RingBuffer(buf_)
		};
	}
};
var _user$project$RingBuffer$push = F2(
	function (value, _p23) {
		var _p24 = _p23;
		var _p25 = _p24._0;
		var maxSize = _user$project$RingBuffer$capacity(_p24);
		var index = A2(_elm_lang$core$Basics_ops['%'], _p25.end + 1, maxSize);
		var array_ = A3(
			_Skinney$elm_array_exploration$Array_Hamt$set,
			index,
			_elm_lang$core$Maybe$Just(value),
			_p25.array);
		var length_ = A2(_elm_lang$core$Basics$min, maxSize, _p25.length + 1);
		var end_ = A2(_elm_lang$core$Basics_ops['%'], _p25.end + 1, maxSize);
		var start_ = A2(_elm_lang$core$Basics_ops['%'], ((maxSize + end_) - length_) + 1, maxSize);
		return _user$project$RingBuffer$RingBuffer(
			{array: array_, length: length_, start: start_, end: end_});
	});
var _user$project$RingBuffer$fromList = F2(
	function (maxSize, values) {
		return _elm_lang$core$Native_Utils.eq(maxSize, 0) ? _user$project$RingBuffer$empty(0) : A3(
			_elm_lang$core$List$foldl,
			_user$project$RingBuffer$push,
			_user$project$RingBuffer$empty(maxSize),
			values);
	});
var _user$project$RingBuffer$set = F3(
	function (externalIdx, value, _p26) {
		var _p27 = _p26;
		var _p28 = _p27._0;
		var internalIdx = A2(
			_elm_lang$core$Basics_ops['%'],
			_p28.start + externalIdx,
			_user$project$RingBuffer$capacity(_p27));
		return _user$project$RingBuffer$RingBuffer(
...
var _user$project$RingBuffer$pushLeft = F2(
	function (value, _p29) {
		var _p30 = _p29;
		var _p32 = _p30;
		var _p31 = _p30._0;
		if (_elm_lang$core$Native_Utils.eq(
			_user$project$RingBuffer$capacity(_p32),
			0)) {
			return _p32;
		} else {
			var maxSize = _user$project$RingBuffer$capacity(_p32);
			var index = A2(
				_elm_lang$core$Basics_ops['%'],
				((maxSize + _p31.start) - A2(_elm_lang$core$Basics_ops['%'], 0, maxSize)) - 1,
				maxSize);
			var array_ = A3(
				_Skinney$elm_array_exploration$Array_Hamt$set,
				index,
				...
				_p31.array);
			var end_ = function () {
				if (_elm_lang$core$Native_Utils.cmp((maxSize - _p31.length) - 1, 0) < 0) {
					var tmpEnd = ((_p31.end + maxSize) - _p31.length) - 1;
					return (_elm_lang$core$Native_Utils.cmp(tmpEnd, 0) < 0) ? (maxSize + A2(_elm_lang$core$Basics_ops['%'], _p31.end, maxSize)) : tmpEnd;
				} else {
					return _p31.end;
				}
			}();
			var length_ = (_elm_lang$core$Native_Utils.cmp(_p31.length, maxSize) < 0) ? ((_elm_lang$core$Native_Utils.cmp(_p31.length + 1, maxSize) > 0) ? maxSize : (_p31.length + 1)) : _p31.length;
			var start_ = A2(_elm_lang$core$Basics_ops['%'], _p31.start - 1, maxSize);
			return _user$project$RingBuffer$RingBuffer(
				{array: array_, length: length_, start: start_, end: end_});
		}
	});
var _user$project$RingBuffer$rotateRight1 = function (_p33) {
	var _p34 = _p33;
	var _p37 = _p34;
	if (_elm_lang$core$Native_Utils.eq(_p34._0.length, 1)) {
		return _p37;
	} else {
		var _p35 = _user$project$RingBuffer$pop(_p37);
		var maybeValue = _p35._0;
		var ring_ = _p35._1;
		var _p36 = maybeValue;
		if (_p36.ctor === 'Nothing') {
			return ring_;
		} else {
			return A2(_user$project$RingBuffer$pushLeft, _p36._0, ring_);
		}
	}
};
var _user$project$RingBuffer$rotateRight = F2(
	function (times, ring) {
		return A3(_user$project$Util$applyRepeatedly, times, _user$project$RingBuffer$rotateRight1, ring);
	});
var _user$project$RingBuffer$popLeft = function (_p38) {
	var _p39 = _p38;
	var _p41 = _p39;
	var _p40 = _p39._0;
	if (_elm_lang$core$Native_Utils.eq(_p40.length, 0)) {
		return {ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: _p41};
	} else {
		var length_ = _p40.length - 1;
		var start_ = A2(
			_elm_lang$core$Basics_ops['%'],
			_p40.start + 1,
			_user$project$RingBuffer$capacity(_p41));
		var array_ = A3(_Skinney$elm_array_exploration$Array_Hamt$set, _p40.start, _elm_lang$core$Maybe$Nothing, _p40.array);
		var maybeValue = _user$project$RingBuffer$first(_p41);
		return {
			ctor: '_Tuple2',
			_0: maybeValue,
			_1: _user$project$RingBuffer$RingBuffer(
				_elm_lang$core$Native_Utils.update(
					_p40,
					{array: array_, start: start_, length: length_}))
		};
	}
};
var _user$project$RingBuffer$rotateLeft1 = function (_p42) {
	var _p43 = _p42;
	var _p46 = _p43;
	if (_elm_lang$core$Native_Utils.eq(_p43._0.length, 1)) {
		return _p46;
	} else {
		var _p44 = _user$project$RingBuffer$popLeft(_p46);
		var maybeValue = _p44._0;
		var ring_ = _p44._1;
		var _p45 = maybeValue;
		if (_p45.ctor === 'Nothing') {
			return ring_;
		} else {
			return A2(_user$project$RingBuffer$push, _p45._0, ring_);
		}
	}
};
var _user$project$RingBuffer$rotateLeft = F2(
	function (times, ring) {
		return A3(_user$project$Util$applyRepeatedly, times, _user$project$RingBuffer$rotateLeft1, ring);
	});
		...
		{ctor: '[]'},
		{
			...
			_0: _elm_lang$html$Html$text(
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(msg.id),
						'> '))),
			_1: {
				ctor: '::',
...
var _user$project$Main$viewBuf = F2(
	function (msg, buf) {
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(buf)),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(
								...
								_elm_lang$core$Basics$toString(
									_user$project$RingBuffer$length(buf)))),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(
									...
									' -- toList=',
									_elm_lang$core$Basics$toString(
										_user$project$RingBuffer$toList(buf)))),
							_1: {
								ctor: '::',
								_0: A2(
...
var _user$project$Main$init = {
	...
	_0: {
		nextId: 1,
		messages: _user$project$RingBuffer$empty(10),
		text: ''
	},
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'RemoveLeft':
				var _p1 = _user$project$RingBuffer$popLeft(model.messages);
				var value = _p1._0;
				var messages_ = _p1._1;
				return {
					ctor: '_Tuple2',
			...
			case 'RotateLeft':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							messages: A2(_user$project$RingBuffer$rotateLeft, 1, model.messages)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'RotateRight':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							messages: A2(_user$project$RingBuffer$rotateRight, 1, model.messages)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'RemoveRight':
				var _p2 = _user$project$RingBuffer$pop(model.messages);
				var value = _p2._0;
				var messages_ = _p2._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'SubmitMessage':
				var id = model.nextId;
				var message = {id: id, text: model.text};
				var model_ = _elm_lang$core$Native_Utils.update(
					model,
					{
						messages: function () {
							var _p3 = _p0._0;
							if (_p3.ctor === 'PushRight') {
								return A2(_user$project$RingBuffer$push, message, model.messages);
							} else {
								return A2(_user$project$RingBuffer$pushLeft, message, model.messages);
							}
						}(),
						nextId: id + 1,
						text: ''
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {messages: a, nextId: b, text: c};
	});
var _user$project$Main$UpdateText = function (a) {
	return {ctor: 'UpdateText', _0: a};
};
var _user$project$Main$RotateRight = {ctor: 'RotateRight'};
var _user$project$Main$RotateLeft = {ctor: 'RotateLeft'};
var _user$project$Main$RemoveLeft = {ctor: 'RemoveLeft'};
var _user$project$Main$RemoveRight = {ctor: 'RemoveRight'};
var _user$project$Main$SubmitMessage = function (a) {
	return {ctor: 'SubmitMessage', _0: a};
};
var _user$project$Main$NoOp = {ctor: 'NoOp'};
var _user$project$Main$PushLeft = {ctor: 'PushLeft'};
var _user$project$Main$PushRight = {ctor: 'PushRight'};
var _user$project$Main$view = function (model) {
	return A2(
		...
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(model.messages)),
			_1: {
				ctor: '::',
				_0: A2(
					...
					A2(
						...
						_user$project$RingBuffer$toList(model.messages))),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$form,
						{
							...
							_0: _elm_lang$html$Html_Events$onSubmit(
								_user$project$Main$SubmitMessage(_user$project$Main$PushRight)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										...
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Main$SubmitMessage(_user$project$Main$PushLeft)),
										_1: {
											ctor: '::',
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('PushLeft '),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('PushRight '),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$RemoveLeft),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('RemoveLeft '),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$RemoveRight),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('RemoveRight '),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$RotateLeft),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('RotateLeft '),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$RotateRight),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('RotateRight '),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
												...
												{ctor: '[]'},
												{
													...
													_0: _elm_lang$html$Html$text(
														A2(
															...
															'First: ',
															_elm_lang$core$Basics$toString(
																_user$project$RingBuffer$first(model.messages)))),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
													...
													{ctor: '[]'},
													{
														...
														_0: _elm_lang$html$Html$text(
															A2(
																...
																'Last: ',
																_elm_lang$core$Basics$toString(
																	_user$project$RingBuffer$last(model.messages)))),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
